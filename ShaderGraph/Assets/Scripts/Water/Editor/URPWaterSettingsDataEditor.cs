...
[CustomEditor(typeof(URPWaterSettingsData))]
public class URPWaterSettingsDataEditor : Editor
{
		...
		switch (refType.enumValueIndex)
		{
			...
			case 1:
			{
				...
				EditorGUILayout.HelpBox(
					"Reflection Probe setting has no options, it automatically uses the nearest reflection probe to the main camera",
					MessageType.Info);
			}
				break;
			case 2:
